...
Three scoring are chosen to evaluate probabilistic forecasts
...
```{r boxplotPIS,include=FALSE,fig.height=10,fig.width=10, out.width="100%", dependson="M3"}
...
```{r boxplot,include=FALSE,fig.height=10,fig.width=10, out.width="100%", dependson="M3"}
# Produce some boxplots
M3long %>%
  mutate(
    period = fct_collapse(period, YEARLY = c("OTHER","YEARLY")),
...
# Reference
  ...
  * Gneiting T, Balabdaoui F, Raftery AE. 2007. Probabilistic forecasts, calibration and sharpness. *J. R. Stat. Soc. B* 67:243â€?68
  
  * Gneiting, T., & Katzfuss, M. (2014). Probabilistic forecasting. *Annual Review of Statistics and Its Application*, 1(1), 125â€?151.
  
  * Gneiting T, Raftery AE. 2007. Strictly proper scoring rules, prediction, and estimation. *J. Am. Stat. Assoc.* 102:359â€?78
  
  * Hersbach, H. (2000), â€œDecomposition of the Continuous Ranked Probability Score for Ensemble Prediction Systems,â€? *Weather and Forecasting*, 15,559â€?570.
...
# Reference
   ...
   * Lowe, Rachel ; Coelho, Caio As ; Barcellos, Christovam ; Carvalho, Marilia SÃ¡ ; CatÃ£o, Rafael De Castro ; Coelho, Giovanini E ; Ramalho, Walter Massa ; Bailey, Trevor C ; Stephenson, David B ; RodÃ³, Xavier eLife, 2016, *Peer Reviewed Journal* Vol.5 
  
  * Matheson, J. E., and Winkler, R. L. (1976), â€œScoring Rules for Continuous Probability Distributions,â€? *Management Science*, 22, 1087â€?1096.
  
  * Raftery, A. E. (2016). Use and communication of probabilistic forecasts. *Statistical Analysis and Data Mining: The ASA Data Science Journal*, 9(6), 397â€?410.
  
  * Roulston, M. S., and Smith, L. A. (2002), â€œEvaluating Probabilistic Forecasts Using Information Theory,â€? *Monthly Weather Review*, 130, 1653â€?1660.
